;SRAV is an embodiment of a Perfectionist
#Persistent
...
{
		;ComObjCreate("SAPI.SpVoice").Speak("Hello Naveen Good Afternoon fill your hours booking")
		MsgBox, 4, SRAV , Hello Naveen Good Afternoon....!!Would you like to fill the hours booking
