...
if !FileExist(flName)
{
	FileAppend, start /d "%A_WorkingDir%" %A_ScriptName%, C:\Users\%A_UserName%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\HB.bat
...
;		notes.Initialize("<password>") 
		Maildb := notes.GETDATABASE("", "C:\ProgramData\Lotus\Notes\Data\Shared\Help\help9_client.nsf")
