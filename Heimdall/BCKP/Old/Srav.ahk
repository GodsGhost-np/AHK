...
!s::
{
	...
	if(Words0=1)
	{
				...
				run, C:\Program Files (x86)\Integrity\IntegrityClient11.0\bin\integrityg.exe
				...
				else ifInString, UserInput, Leaveplan
				run, \\ozfs002a\didn7740\PD_ElectronicsApplicationEngg\Reference\11_Others\EBT Leave Plan\EBT Leave Plan.xlsx
				...
				{
				readConfig()
					run, C:\Program Files (x86)\Google\Chrome\Application\chrome.exe "http://ozd1758g/"
					WinWaitActive, 0zd1758g - Google Chrome, , 3
					sleep, 1000
					 Send, %A_UserName%
					sleep, 50
					send, {Tab}
				...
				readConfig()
					...
					;run, C:\Program Files (x86)\Citrix\ICA Client\pnagent.exe ALLOWSAVEPWD=A /CitrixShortcut: (2) /QLaunch "XenAppCW01:DOORS ADAS"
				...
				run C:\Users\uidn8279\Desktop\AHK\SRAV\Reminder.exe %MyDate%%MyTime% "%ReminderText%"
				Gui Cancel
				return
					...
					;   run C:\Users\uidn8279\Desktop\AHK\SRAV\Reminder.exe %time% "%RemInput%"
					;}
				}
